...
export const loadCarsSuccess = createAction(
    ...
    props<{ cars: Car[]; totalCount: string }>(),
);
...
export const createCar = createAction(
    '[Car] create car',
    props<{ carData: { name: string; color: string } }>(),
);
...
export const selectCar = createAction(
    '[Car] select car',
    props<{ selectedCar: Car | null }>(),
);
export const isMoving = createAction(
    '[Car] moving car',
    props<{ isMoving: boolean }>(),
);
