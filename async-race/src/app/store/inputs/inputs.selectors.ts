...
export const getCreateFormInput = createSelector(getCreateFormState, (state) => state.createCarForm);

export const getUpdateFormInput = createSelector(getUpdateFormState, (state) => state.updateCarForm);
