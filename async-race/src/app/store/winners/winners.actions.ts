...
export const loadWinnersFail = createAction("[Winners] load winners fail", props<{ error: any }>());
...
export const createWinner = createAction("[Winner] create winner", props<{ winner: Winner }>());
...
export const updateWinnerSuccess = createAction("[Winner] update winner success", props<{ winner: Winner }>());

export const deleteWinner = createAction("[Winner] delete winner", props<{ winnerID: number }>());
export const deleteWinnerSuccess = createAction("[Winner] delete winner success");
